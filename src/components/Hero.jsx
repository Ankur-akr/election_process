...
const Hero = () => {
  return (
    <section id="home" className="section" style={{ position: 'relative', paddingTop: '10rem', paddingBottom: '6rem' }}>
      {/* Background Graphic wrapper to prevent horizontal scroll without clipping section vertically */}
      <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', zIndex: -1, pointerEvents: 'none' }}>
        <div style={{ position: 'absolute', top: '-10%', left: '-10%', width: '400px', height: '400px', background: 'radial-gradient(circle, rgba(255,153,51,0.2) 0%, rgba(255,153,51,0) 70%)', borderRadius: '50%' }}></div>
        <div style={{ position: 'absolute', bottom: '-10%', right: '-10%', width: '400px', height: '400px', background: 'radial-gradient(circle, rgba(19,136,8,0.2) 0%, rgba(19,136,8,0) 70%)', borderRadius: '50%' }}></div>
      </div>
      ...
      <div className="container text-center animate-fade-in">
        ...
        <h1 style={{ fontSize: 'clamp(2.2rem, 6vw, 4.5rem)', marginBottom: '1.5rem', color: 'var(--text-color)' }}>
